...
def banded_global_alignment(v, w, match_score, mismatch_penalty, indel_penalty, band_width, scoring_matrix=None):
...
(score, v_aligned, w_aligned) = banded_global_alignment(v, w, match_score, mismatch_penalty, indel_penalty, band_width)
